...
public class MmenuIconContent extends ConstraintLayout {
    private int orientation = MmenuIconContentOrientation.CIRCLE;
    private Drawable iconSrc = getResources().getDrawable(R.mipmap.ic_launcher_foreground,null);
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        if(orientation == MmenuIconContentOrientation.CIRCLE)
        {
        ...
        if(orientation != MmenuIconContentOrientation.CIRCLE)
        {
            ...
            LayoutParams layoutParams = (LayoutParams)TextGroup.getLayoutParams();
            if(orientation == MmenuIconContentOrientation.LEFT)//<==
                layoutParams.leftMargin = MarginRight;
            else if(orientation == MmenuIconContentOrientation.RIGHT)//==>
