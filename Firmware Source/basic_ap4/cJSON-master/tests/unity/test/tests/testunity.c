...
#define TEST_ASSERT_EQUAL_PRINT_FLOATING(expected, actual) {            \
        startPutcharSpy(); UnityDebugloat((actual)); endPutcharSpy();  \
        TEST_ASSERT_EQUAL_STRING((expected), getBufferPutcharSpy());    \
        }
...
static void DebugloatValue(float f)
{
    char expected[18];
...
void testFloatPrintingRandomSamples(void)
{
    ...
    u.int_value = 0x00000000; DebugloatValue(u.f_value);
    u.int_value = 0x80000000; DebugloatValue(u.f_value);
    u.int_value = 0x7fffffff; DebugloatValue(u.f_value);
    u.int_value = 0xffffffff; DebugloatValue(u.f_value);
    ...
    for(int num_tested = 0; num_tested < 1000000; num_tested++)
    {
        ...
        u.int_value = a;              DebugloatValue(u.f_value);
        u.int_value = a | 0x80000000; DebugloatValue(u.f_value);
    }
#endif
}
