...
uint8_t old_tcp_client_state = 0;
uint16_t EtherCard::packetLoop (uint16_t plen) {
    tcp_client_st = tcp_client_state;
    if(old_tcp_client_state != tcp_client_state){
        Serial.printf("tcp_client_state : [%d -> %d]\r\n", old_tcp_client_state, tcp_client_state);
        old_tcp_client_state = tcp_client_state;
    }
